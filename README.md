...
- The browser booking configuration uses `VITE_BOOKING_TIMEZONE`; keep this value aligned with the server-side calendar timezone.
...
- GitHub Actions runs tests, type-checking, the production build, and the prerendered SEO audit on pushes and pull requests.
