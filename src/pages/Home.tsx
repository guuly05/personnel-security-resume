  ...
  <div className="space-y-5">
    <section className="surface-card home-hero p-6 md:p-10 lg:p-12">
      <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div>
          <div className="mb-5 inline-flex items-center gap-2 rounded-md border border-[var(--accent)]/25 bg-[var(--accent-soft)] px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.28em] text-[var(--accent)]">
          ...
          <a href="/about" className="inline-flex items-center gap-2 rounded-md border border-[var(--border)] bg-[var(--surface-soft)] px-5 py-3 text-sm font-semibold text-[var(--color-text)] transition-colors hover:border-[var(--accent)]">
